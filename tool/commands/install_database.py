...
from commands.interface import emit_from_interface, interface_install_database
...
def cmd_install_database(args: Namespace) -> int:
    ...
    return emit_from_interface(args, interface_install_database(force=force), opts)
