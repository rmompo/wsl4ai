...
| [specs-install.md](specs-install.md) | `wsl4ai install ...` — `tool`, `database`, `alias`, `update` and related rules. |
...
| [specs-start.md](specs-start.md) | `wsl4ai start` — run one mounted use in foreground. |
| [specs-tui.md](specs-tui.md) | `wsl4ai tui` — interactive Text User Interface specification, theme model, and TUI picker behavior. |
